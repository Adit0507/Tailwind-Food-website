...
const Food = () => {
  ...
  // Filter type burgers pizza salads etc.
  ...
  return (
    <div className="max-w-[1640px] m-auto px-4 py-12">
      ...
      {/* Display Foods */}
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 pt-7">
        {foods.map((item, index) => (
          // Duration helps in avoiding the "jumpy" effect
          // rounded-lg gives the rounded side
          <div
            key={index}
